  ...
  <div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
      <div class="am-fl am-cf">
        <strong class="am-text-primary am-text-lg">新增产品</strong> /
    ...
    <form id="form1" action="/coal-gas-system/product/insert" method="post" autocomplete="off" class="am-form">
        ...
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="number" class="am-input-sm" name="id">
              </div>
            </div>
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-12 am-u-md-10">
                <textarea rows="5" name="remark" style="width:580px;" placeholder="选填，有需求请备注..."></textarea>
              </div>
            </div>
