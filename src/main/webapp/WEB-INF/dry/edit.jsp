  ...
  <div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
      <div class="am-fl am-cf">
        <strong class="am-text-primary am-text-lg">编辑干燥</strong> /
        <small>Edit Dry</small>
      </div>
    </div>

    <hr>

    <form id="form1" action="/coal-gas-system/dry/update?id=${dry.id }" method="post" autocomplete="off" class="am-form">
        ...
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="number" class="am-input-sm" name="coalDepotId" value="${dry.coalDepotId }">
              </div>
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="number" class="am-input-sm" id="formerAmount" name="formerAmount" value="${dry.formerAmount }" onblur="calculateDryPercent()">
              </div>
              	t
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="number" class="am-input-sm" id="laterAmount" name="laterAmount" value="${dry.laterAmount }" onblur="calculateDryPercent()">
              </div>
              	t
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="number" class="am-input-sm" id="dryPercent" name="dryPercent" value="${dry.dryPercent }" readonly="readonly">
              </div>
              	%
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="number" class="am-input-sm" name="dryTime" value="${dry.dryTime }">
              </div>
              	h
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="text" class="am-input-sm" name="confirmPerson" value="${dry.confirmPerson }">
              </div>
            </div>
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-12 am-u-md-10">
                <textarea rows="5" name="remark" style="width:580px;">${dry.remark }</textarea>
              </div>
            </div>
