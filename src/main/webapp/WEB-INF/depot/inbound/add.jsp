  ...
  <div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
      <div class="am-fl am-cf">
        <strong class="am-text-primary am-text-lg">入库</strong> /
        <small>In Bound</small>
      </div>
    </div>
    ...
    <div class="am-tabs am-margin" data-am-tabs>
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab1">入库信息</a></li>
      </ul>
        ...
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="number" class="am-input-sm" id="truckId" name="truckId" onblur="clearMessageSubmit()">
              </div>
            </div>
    ...
    <div class="am-margin">
      <button type="button" class="am-btn am-btn-primary am-btn-xs" onclick="submit()">提交入库</button>
      <button type="button" class="am-btn am-btn-primary am-btn-xs" onclick="history.back()">放弃入库</button>
...
<script type="text/javascript">
	...
	function clearMessageSubmit() {
		if ("" != $("message_submit").innerText) {
			if ("" != $V("depotId") && "" != $V("truckId") && "" != $V("amount") && "" != $V("unitPrice") && "" != $V("totalPrice") && "" != $V("comfirmPerson")) {
