...
<div class="admin-content">
  <div class="admin-content-body">
    ...
    <form id="form1" action="/coal-gas-system/order/insert" method="post" autocomplete="off" class="am-form">
      ...
      <div class="am-tabs-bd">
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="number" class="am-input-sm" name="amount">
              </div>
              	m³
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="number" class="am-input-sm" name="totalPrice">
              </div>
              	￥
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="text" class="am-input-sm" name="purchaser">
              </div>
            </div>
